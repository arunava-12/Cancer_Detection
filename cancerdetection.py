...
ROOT_DIR = r"D:\VS-Code\Cancer_Detection\data"
number_of_images = {}
...
def dataFolder(p, split):
    train_path = os.path.join("D:\\VS-Code\\Cancer_Detection", p)
...
train_path = r"D:\VS-Code\Cancer_Detection\train"
...
test_path = r"D:\VS-Code\Cancer_Detection\test"
test_data = preprocessingImages2(test_path)

val_path = r"D:\VS-Code\Cancer_Detection\val"
val_data = preprocessingImages2(val_path)

from keras.callbacks import ModelCheckpoint, EarlyStopping

es = EarlyStopping(monitor="val_accuracy", min_delta=0.01, patience=3, verbose=1, mode='auto')
mc = ModelCheckpoint(monitor="val_accuracy", filepath="D:\\VS-Code\\Cancer_Detection\\bestmodel.h5", verbose=1, save_best_only=True, mode="auto")
cd = [es, mc]
